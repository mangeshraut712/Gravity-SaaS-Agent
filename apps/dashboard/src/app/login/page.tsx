...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      <div className="pointer-events-none absolute -top-24 left-16 h-72 w-72 rounded-full bg-emerald-300/30 blur-3xl" />
      <div className="pointer-events-none absolute bottom-12 right-10 h-80 w-80 rounded-full bg-sky-300/30 blur-3xl" />
          ...
          <div className="hidden flex-col justify-center gap-8 lg:flex">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-5 shadow-sm">
              ...
              <div className="mt-4 flex items-center gap-2 text-xs text-slate-500">
                <span className="inline-flex h-6 items-center rounded-full bg-emerald-100 px-3 text-emerald-700">
                  Live
                </span>
            ...
            <div className="flex items-center gap-6 text-xs text-slate-500">
              ...
              <div>
                <p className="text-lg font-semibold text-slate-900">8 min</p>
